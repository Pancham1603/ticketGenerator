...
class FreeTypeFont:
    ...
    def getlength(self, text, mode="", direction=None, features=None, language=None):
        ...
        .. code-block:: python
          ...
          ***REMOVED*** = font.getlength("Hello")
          world = font.getlength("World")
          ***REMOVED***_world = ***REMOVED*** + world  # not adjusted for kerning
          assert ***REMOVED***_world == font.getlength("HelloWorld")  # may fail

        use

        .. code-block:: python

          ***REMOVED*** = font.getlength("HelloW") - font.getlength("W")  # adjusted for kerning
          world = font.getlength("World")
          ***REMOVED***_world = ***REMOVED*** + world  # adjusted for kerning
          assert ***REMOVED***_world == font.getlength("HelloWorld")  # True

        or disable kerning with (requires libraqm)

        .. code-block:: python

          ***REMOVED*** = draw.textlength("Hello", font, features=["-kern"])
          world = draw.textlength("World", font, features=["-kern"])
          ***REMOVED***_world = ***REMOVED*** + world  # kerning is disabled, no need to adjust
          assert ***REMOVED***_world == draw.textlength("HelloWorld", font, features=["-kern"])
